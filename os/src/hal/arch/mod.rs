...
pub use loongarch64::{
    ...
    config::MEMORY_END,
    console_flush, console_getchar, console_putchar, console_write_bytes,
...
pub use riscv::{
    ...
    machine_init,
    rv_board::MMIO,
    sbi::{console_flush, console_getchar, console_putchar, console_write_bytes, local_irq_restore, local_irq_save, set_timer, shutdown},
    sv39::tlb_invalidate,
    switch::__switch,
    syscall_id,
    time::{get_clock_freq, get_time, program_timer_delta, TICKS_PER_SEC},
