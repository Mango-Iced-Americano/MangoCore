...
pub use loongarch64::{
    ...
    boot_cpu_local_ptr, boot_cpu_park, install_boot_cpu_local, local_irq_restore,
...
#[cfg(feature = "riscv")]
pub use riscv::{
    boot_cpu_local_ptr, boot_cpu_park, bootstrap_init, config,
    ...
    install_boot_cpu_local, machine_init, start_secondary_cpu,
    rv_board::MMIO,
    sbi::{
