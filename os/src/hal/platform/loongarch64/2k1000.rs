...
/// Match the ext4 backend's 4 KiB block contract.
...
/// APB Device 2 RNG register. Every 32-bit volatile read returns a random word.
pub const RNG_BASE: usize = 0x1FE2_B000 + HIGH_BASE_EIGHT;
