...
pub use arch::init_kernel_mapping_metadata;
...
pub use arch::{
    configure_runtime_console, drain_runtime_console_rx, init_runtime_console_rx,
    take_runtime_console_rx_interrupt,
};
...
pub use arch::{BLOCK_SZ, BUFFER_CACHE_NUM, KERNEL_BOOTSTRAP_HEAP_SIZE, TICKS_PER_SEC};
...
/// Per-chunk bounce buffer ceiling. Runtime heap capacity is unavailable to a
/// const expression and this established 256 KiB cap stays independent of RAM.
pub const IO_CHUNK_SIZE: usize = 256 * 1024;
