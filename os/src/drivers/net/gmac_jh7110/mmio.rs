...
pub(super) const SYS_CRG_GMAC0_GTXCLK: usize = 0x01b0;
...
pub(super) const AON_CRG_GMAC0_TX_MUX: usize = 0x0014;
...
pub(super) fn write_mmio(base: usize, offset: usize, value: u32) {
    ...
    // aligned documented JH7110 registers in the identity-mapped MMIO window.
