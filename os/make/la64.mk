...
kernel:
	@echo Platform: $(BOARD)
ifeq ($(MODE), debug)
	@LOG=$(LOG) cargo build --features "board_$(BOARD) $(LOG_OPTION) block_$(BLK_MODE) oom_handler heap_trace" --no-default-features --target loongarch64-unknown-none
else
	@LOG=$(LOG) cargo build --release --features "board_$(BOARD) $(LOG_OPTION) block_$(BLK_MODE) oom_handler heap_trace" --no-default-features --target loongarch64-unknown-none
endif
