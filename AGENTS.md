...
| `clock_gettime03/04`、`cve-*`、`dirtyc0w*`、`crypto_user*`、`copy_file_range03` 等中段噪声 | time namespace 配置、clock 性能阈值、procfs/CVE、crypto netlink、fs timestamp 环境缺失 | broad scan 中先跳过，后续如专攻性能/time/fs/procfs 再单独恢复 |
