...
| `clock_gettime03/04`、`cve-*`、`dirtyc0w*`、`dirtypipe`、`crypto_user*`、`dns*`、`doio` 等中段噪声 | time namespace 配置、clock 性能阈值、procfs/CVE、pipe/fs、crypto netlink、DNS/net、I/O 压测环境缺失 | broad scan 中先跳过，后续如专攻性能/time/fs/procfs/net 再单独恢复 |
