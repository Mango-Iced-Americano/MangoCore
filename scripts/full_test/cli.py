...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--fixture", choices=("build-failure", "extraction-failure", "qemu-timeout", "missing-terminal-marker", "judge-missing-group", "judge-nonzero", "qemu-nonzero"))
    return parser
