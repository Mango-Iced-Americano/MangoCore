...
pub const DEFAULT_TIMEOUTS: [u64; 15] = [60, 120, 60, 120, 480, 900, 40, 120, 900, 90, 60, 24000, 600, 18000, 180];
const DEFAULT_ORDER: [&str; 15] = ["basic", "busybox", "lua", "lmbench", "iozone", "libcbench", "netperf", "iperf", "libctest", "cyclictest", "ltp", "cpython", "unixbench", "cagent", "buildstorm"];
