...
// fix me
// Note: stdout is declared extern in <stdio.h>; weak override must match qualifiers.
__attribute__((weak)) 
FILE * stdout = NULL;
...
void qsort(void *base,
           ...
           __compar_fn_t comp)
{
        qsort_r(base, nel, width, (__compar_d_fn_t)comp, NULL);
}

// ── Fortified wrappers emitted by glibc-linux-gnu toolchain at -O2 ───────
// Since this is bare-metal (no glibc), forward to the non-fortified
// implementations already present in this file.
